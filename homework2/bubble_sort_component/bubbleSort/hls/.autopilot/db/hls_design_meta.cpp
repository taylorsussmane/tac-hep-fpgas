...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("arr_address1", 4, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("arr_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("arr_we1", 1, hls_out, 0, "ap_memory", "MemPortWE2", 1),
	Port_Property("arr_d1", 32, hls_out, 0, "ap_memory", "MemPortDIN2", 1),
	Port_Property("arr_q1", 32, hls_in, 0, "ap_memory", "MemPortDOUT2", 1),
};
