...
dict set ap_memory_interface_dict arr { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
...
set portList { 
	...
	{ arr_d0 sc_out sc_lv 32 signal 0 } 
	...
	{ arr_d1 sc_out sc_lv 32 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "91", "EstimateLatencyMax" : "511",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "arr", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_bubbleSort_Pipeline_VITIS_LOOP_16_2_fu_44", "Port" : "arr", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_13_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_bubbleSort_Pipeline_VITIS_LOOP_16_2_fu_44", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_bubbleSort_Pipeline_VITIS_LOOP_16_2_fu_44.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "91", "Max" : "511"}
	, {"Name" : "Interval", "Min" : "92", "Max" : "512"}
]}
