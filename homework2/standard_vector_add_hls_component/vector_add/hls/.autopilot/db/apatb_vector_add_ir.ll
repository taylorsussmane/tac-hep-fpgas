; ModuleID = '/scratch/tsussman/standard_vector_add_hls_component/vector_add/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_vector_add_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" %a, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" %b, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" %c) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_vector_add_hw([100 x i32]* %a_copy, [100 x i32]* %b_copy, [100 x i32]* %c_copy)
...
declare void @apatb_vector_add_hw([100 x i32]*, [100 x i32]*, [100 x i32]*)
...
define void @vector_add_hw_stub_wrapper([100 x i32]*, [100 x i32]*, [100 x i32]*) #5 {
entry:
  ...
  call void @vector_add_hw_stub(i32* %3, i32* %4, i32* %5)
  call void @copy_in([100 x i32]* null, [100 x i32]* %0, [100 x i32]* null, [100 x i32]* %1, [100 x i32]* null, [100 x i32]* %2)
  ret void
}

declare void @vector_add_hw_stub(i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull)
