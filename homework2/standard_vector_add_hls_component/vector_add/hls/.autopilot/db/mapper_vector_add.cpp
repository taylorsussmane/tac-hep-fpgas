...
using hls::sim::Byte;
extern "C" void vector_add(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_vector_add_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
...
__xlx_c__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_c)[i]);
  ...
  // DUT call
  vector_add(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data());
