...
dict set ap_memory_interface_dict A { MEM_WIDTH 32 MEM_SIZE 400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict B { MEM_WIDTH 32 MEM_SIZE 400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict C { MEM_WIDTH 32 MEM_SIZE 400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ A int 32 regular {array 100 { 1 1 } 1 1 }  }
	{ B int 32 regular {array 100 { 1 1 } 1 1 }  }
	{ C int 32 regular {array 100 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_5_1_VITIS_LOOP_6_2", "PipelineType" : "UPC",
