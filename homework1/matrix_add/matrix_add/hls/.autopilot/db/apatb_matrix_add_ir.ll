; ModuleID = '/scratch/tsussman/matrix_add/matrix_add/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_matrix_add_ir([10 x i32]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="10" %A, [10 x i32]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="10" %B, [10 x i32]* noalias nocapture nonnull "fpga.decayed.dim.hint"="10" %C) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_matrix_add_hw([10 x [10 x i32]]* %A_copy, [10 x [10 x i32]]* %B_copy, [10 x [10 x i32]]* %C_copy)
...
declare void @apatb_matrix_add_hw([10 x [10 x i32]]*, [10 x [10 x i32]]*, [10 x [10 x i32]]*)
...
define void @matrix_add_hw_stub_wrapper([10 x [10 x i32]]*, [10 x [10 x i32]]*, [10 x [10 x i32]]*) #5 {
entry:
  ...
  call void @matrix_add_hw_stub([10 x i32]* %3, [10 x i32]* %4, [10 x i32]* %5)
...
declare void @matrix_add_hw_stub([10 x i32]* noalias nocapture nonnull readonly, [10 x i32]* noalias nocapture nonnull readonly, [10 x i32]* noalias nocapture nonnull)
