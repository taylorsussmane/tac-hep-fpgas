...
using hls::sim::Byte;
extern "C" void matrix_add(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_matrix_add_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C) {
...
__xlx_C__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_C)[i]);
  ...
  // DUT call
  matrix_add(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data());
